...
4. Use the [Kafka message sender tool](https://github.com/companieshouse/chs-tools/tree/add_kafka_message_sender) to send test messages
...
In the event of an error occurring while processing a message, the message will be placed into the `refund-request-retry` topic. If it continues to fail, the message will be placed into the `refund-request-error` topic to be examined by FESS.

## Design

See [design documentation](./docs/design/readme.md).

## Testing

See [testing documentation](./docs/testing/readme.md).
